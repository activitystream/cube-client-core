...
import { pipe, map, filter, reduce, minBy, maxBy, unnest, groupBy, flatten, fromPairs, pluck, mergeDeepLeft, mergeAll, uniq, dropLast, clone, equals } from 'ramda';
...
export { HttpTransport, ResultSet, defaultHeuristics, defaultOrder, flattenFilters, isQueryPresent, moveItemInArray, movePivotItem };
